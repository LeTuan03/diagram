        ...
        <div className="w-full h-screen overflow-hidden relative chart-video-container">
            ...
            <div className="grid grid-cols-12 gap-6 h-full pb-12 px-4 ">
                <div className="col-span-3 p-6 z-10">
                    ...
                    <ModernBarChart />
                    <div className="mt-8">
                        <LabelTitleComponent title="Area Chart" />
                        <ModernAreaChart />
                    </div>
                    <ModernDoughnutChart />
                </div>
                <div className="col-span-6 z-10 relative" style={{ height: "fit-content" }}>
                    <div className="bg-white/10 backdrop-blur-sm rounded-xl p-4 mt-2 border border-white/20">
                        <div className="grid grid-cols-1 md:grid-cols-4 gap-4 items-stretch ">
                            {/* Toggle Controls */}
                            <div className="bg-black/20 rounded-lg p-4 flex flex-col justify-between">
                                <div className="text-white text-sm font-semibold mb-2">Tùy chọn hiển thị:</div>
                            ...
                            <div className="bg-black/20 rounded-lg p-4 flex flex-col justify-between">
                                <div className="text-white text-sm space-y-2">
                                    <div className="flex justify-between">
                                        ...
                                        <span className="font-mono text-blue-400">{zoomRatio?.toFixed(2) || 'N/A'}</span>
                                    </div>
                                    <div className="flex justify-between">
                                        <span>Map Type:</span>
                                        <span className="text-green-400">{useDetailedMap ? 'Chi tiết' : 'Tổng quan'}</span>
                                    </div>
                                    <div className="flex justify-between">
                                        <span>Clusters:</span>
                            ...
                            {/* Feature Status */}
                            <div className="bg-black/20 rounded-lg p-4 flex flex-col justify-between">
                                <div className="text-white text-sm mb-2">Trạng thái:</div>
