...
const Tab7: React.FC = () => {
    ...
    const markerData: MarkerData[] = [
        { id: "hcm", lat: 10.8231, lon: 106.6297, name: "TP.HCM", value: 95, category: "major" },
        { id: "cantho", lat: 10.0452, lon: 105.7469, name: "Cần Thơ", value: 65, category: "medium" },
        { id: "thuduc", lat: 10.9804, lon: 106.6750, name: "Thủ Đức", value: 45, category: "small" },
        { id: "quan1", lat: 10.7769, lon: 106.7009, name: "Quận 1", value: 50, category: "small" },
        { id: "tanan", lat: 10.7546, lon: 106.4230, name: "Tân An", value: 35, category: "small" },
        { id: "vungtau", lat: 10.4113, lon: 107.1365, name: "Vũng Tàu", value: 55, category: "medium" },
        { id: "camau", lat: 9.1767, lon: 105.1524, name: "Cà Mau", value: 38, category: "small" }
    ];
    ...
    const markerSeriesData = clusters.map((cluster, index) => ({
        id: cluster.id,
    ...
    if (showMarkers) {
        series.push({
            ...
            tooltip: {
                pointFormat: '<b>{point.name}</b><br/>Tổng giá trị: {point.value}<br/>Số điểm: {point.count}',
            },
            point: {
                events: {
                    click: function (this: any) {
